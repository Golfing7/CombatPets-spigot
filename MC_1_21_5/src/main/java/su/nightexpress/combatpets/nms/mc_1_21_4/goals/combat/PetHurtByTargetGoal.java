package su.nightexpress.combatpets.nms.mc_1_21_4.goals.combat;
...
public class PetHurtByTargetGoal extends TargetGoal {
    ...
    public void start() {
        ...
        if (petLastAttacker != null) {
            this.mob.setTarget(this.mob.getLastHurtByMob(), EntityTargetEvent.TargetReason.TARGET_ATTACKED_ENTITY);
            this.targetMob = this.mob.getTarget();
        }
        else if (this.ownerLastAttacker != null) {
            this.mob.setTarget(this.ownerLastAttacker, EntityTargetEvent.TargetReason.TARGET_ATTACKED_OWNER);
        }
        else if (this.ownerLastVictim != null) {
            this.mob.setTarget(this.ownerLastVictim, EntityTargetEvent.TargetReason.OWNER_ATTACKED_TARGET);
        }
