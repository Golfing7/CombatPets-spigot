...
import su.nightexpress.combatpets.nms.mc_1_21_4.goals.combat.PetRangedAttackGoal;
...
public class WitherPet extends WitherBoss implements PetEntity {
    ...
    protected void customServerAiStep(ServerLevel worldserver) {
        Reflex.setFieldValue(this, "nextHeadUpdate", new int[]{Integer.MAX_VALUE, Integer.MAX_VALUE}); // nextHeadUpdate
